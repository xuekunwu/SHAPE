        ...
        with gr.Row():
            with gr.Column(scale=5):
                ...
                examples = [
                    ...
                    ["Multi-channel organoid cohort (short)", ["examples/bs_E2.tiff", "examples/d2_E2.tiff", "examples/d4_E2.tiff", "examples/d6_E2.tiff", "examples/d8_E2.tiff", "examples/d10_E2.tiff", "examples/d12_E2.tiff", "examples/d16_E2.tiff"], "What changes of organoid morphology among different treatment groups?", "Organoid_Segmenter_Tool, Single_Cell_Cropper_Tool, Cell_State_Analyzer_Tool, Analysis_Visualizer_Tool", "Organoid clustering, UMAP embedding, Group comparison. Comparative analysis across treatment groups with statistical testing."],
