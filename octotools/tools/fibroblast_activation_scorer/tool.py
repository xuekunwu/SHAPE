...
class Fibroblast_Activation_Scorer_Tool(BaseTool):
    ...
    def _generate_visualizations(self, query_data: ad.AnnData, reference_data: ad.AnnData, 
        ...
        try:
            ...
            font_size = vis_config.PROFESSIONAL_STYLE.get('font.size', 18)
            title_size = vis_config.PROFESSIONAL_STYLE.get('axes.titlesize', 24)
            label_size = vis_config.PROFESSIONAL_STYLE.get('axes.labelsize', 20)
            tick_size = vis_config.PROFESSIONAL_STYLE.get('xtick.labelsize', 16)
