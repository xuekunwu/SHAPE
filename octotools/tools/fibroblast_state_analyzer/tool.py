...
class Fibroblast_Activation_Scorer_Tool(BaseTool):
    ...
    def __init__(self, **kwargs):
        ...
        self.input_types = {
            "cell_data": "Union[str, List[str]] - Path to cell data file or list of cell crop paths",
            "reference_source": "str - Reference source ('huggingface' or 'local')",
            "reference_repo_id": "str - Hugging Face repository ID",
            "reference_filename": "str - Reference filename in Hugging Face repo",
            "local_reference_path": "Optional[str] - Local path to reference file",
            "output_dir": "str - Output directory for results",
            "visualization_type": "str - Visualization type ('basic', 'comprehensive', 'all')",
