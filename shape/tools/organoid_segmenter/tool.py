    ...
    def execute(self, image, diameter=100, flow_threshold=0.4, cellprob_threshold=0, model_path=None, query_cache_dir=None, image_id=None, **kwargs):
        ...
        try:
            ...
            if needs_brightness_adjustment:
                print(f"âš ï¸ Brightness check: {brightness_reason}")
                ...
                try:
                    ...
                    print(f"âœ?Successfully adjusted brightness. New brightness: {np.mean(phase_contrast_img):.1f}")
                ...
                print(f"âœ?Brightness check passed: {brightness_reason}")
...
if __name__ == "__main__":
    ...
    cd shape/tools/organoid_segmenter
    python tool.py
    """
